...
- The distribution is symmetric about $\theta$,
\vfill

- about $95\%$ of the mass resides within 
\vfill

- if $X \sim N(\mu,\tau^2)$ and $Y \sim N(\theta,\sigma^2)$ and $X$ and $Y$ are independent, then $aX + bY$
\vfill
...
\end{equation*}
\vfill
Similarly the term associated with $2 \theta$ is \vfill
\begin{equation*}
E[\theta] = 
\end{equation*}
\vfill
...
1. sample $\theta^{(i+1)}$ from 
\vfill

2. sample $\sigma^{2(i+1)}$ from 
\vfill
